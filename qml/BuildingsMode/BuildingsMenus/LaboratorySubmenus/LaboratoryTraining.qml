...
Item {
    ...
    Image {
        ...
        source: "qrc:/graphics/GUI/Laboratory/Laboratory_Background.png"
    }
    ...
    Text {
        ...
        width: 800
        color: "#94ef94"
        text: "Studying in the laboratory improves\nmercenary's mind condition\nand knowledge.\n\nNoticable performance\nimprovements appear\nafter X days of\ntraining."

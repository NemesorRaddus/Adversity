        ...
        MercenariesList {
            ...
            onMercenaryClicked: {
                ...
                case 0:
                    ...
                    slotView1.setMercenaryTwoVals("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.gym.useCostInEnergySingle(),GameApi.base.buildings.gym.duration()+1);
                    state = "hidden";
                    break;
                case 1:
                    slotView2.mercenaryName=mercenaryName;
                    slotView2.setMercenaryTwoVals("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.gym.useCostInEnergySingle(),GameApi.base.buildings.gym.duration()+1);
                    state = "hidden";
                    break;
                case 2:
                    slotView3.mercenaryName=mercenaryName;
                    slotView3.setMercenaryTwoVals("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.gym.useCostInEnergySingle(),GameApi.base.buildings.gym.duration()+1);
                    state = "hidden";
                    break;
                }

    ...
    function updateEverything()
    {
        ...
        if (amountOfSlotsAvailable>=1)
        {
            if (GameApi.base.buildings.playingField.mercenaryNameInSlot(0)!="")
            {
                ...
                slotView1.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(GameApi.base.buildings.playingField.mercenaryProfessionInSlot(0))+"/"+GameApi.base.buildings.playingField.mercenaryNameInSlot(0)+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
            ...
            if (amountOfSlotsAvailable>=2)
            {
                if (GameApi.base.buildings.playingField.mercenaryNameInSlot(1)!="")
                {
                    ...
                    slotView2.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(GameApi.base.buildings.playingField.mercenaryProfessionInSlot(1))+"/"+GameApi.base.buildings.playingField.mercenaryNameInSlot(1)+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                ...
                if (amountOfSlotsAvailable>=3)
                {
                    if (GameApi.base.buildings.playingField.mercenaryNameInSlot(2)!="")
                    {
                        ...
                        slotView3.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(GameApi.base.buildings.playingField.mercenaryProfessionInSlot(2))+"/"+GameApi.base.buildings.playingField.mercenaryNameInSlot(2)+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    ...
                    if (amountOfSlotsAvailable>=4)
                    {
                        if (GameApi.base.buildings.playingField.mercenaryNameInSlot(3)!="")
                        {
                            ...
                            slotView4.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(GameApi.base.buildings.playingField.mercenaryProfessionInSlot(3))+"/"+GameApi.base.buildings.playingField.mercenaryNameInSlot(3)+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                        ...
                        if (amountOfSlotsAvailable>=5)
                        {
                            if (GameApi.base.buildings.playingField.mercenaryNameInSlot(4)!="")
                            {
                                ...
                                slotView5.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(GameApi.base.buildings.playingField.mercenaryProfessionInSlot(4))+"/"+GameApi.base.buildings.playingField.mercenaryNameInSlot(4)+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                            ...
                            if (amountOfSlotsAvailable==6)
                            {
                                if (GameApi.base.buildings.playingField.mercenaryNameInSlot(5)!="")
                                {
                                    ...
                                    slotView6.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(GameApi.base.buildings.playingField.mercenaryProfessionInSlot(5))+"/"+GameApi.base.buildings.playingField.mercenaryNameInSlot(5)+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
        ...
        MercenariesList {
            ...
            onMercenaryClicked: {
                ...
                case 0:
                    ...
                    slotView1.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    state = "hidden";
                    break;
                case 1:
                    slotView2.mercenaryName=mercenaryName;
                    slotView2.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    state = "hidden";
                    break;
                case 2:
                    slotView3.mercenaryName=mercenaryName;
                    slotView3.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    state = "hidden";
                    break;
                case 3:
                    slotView4.mercenaryName=mercenaryName;
                    slotView4.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    state = "hidden";
                    break;
                case 4:
                    slotView5.mercenaryName=mercenaryName;
                    slotView5.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    state = "hidden";
                    break;
                case 5:
                    slotView6.mercenaryName=mercenaryName;
                    slotView6.setMercenaryOneVal("qrc:/graphics/Mercenaries/"+GameApi.globalsCpp.alterNormalTextToInternal(mercenaryProfession)+"/"+mercenaryName+".png",GameApi.base.buildings.playingField.useCostInEnergySingle());
                    state = "hidden";
                    break;
                }

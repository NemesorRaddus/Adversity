...
struct PlayingFieldLevelInfo : public BuildingLevelInfo
{
...
public:
    explicit PlayingField(Base *base, unsigned level, const AnyBuildingLevelsInfo *levelsInfo) noexcept;
...
private:
    PlayingFieldLevelInfo *currentLevelInfo() const noexcept;
    PlayingFieldLevelInfo *nextLevelInfo() const noexcept;

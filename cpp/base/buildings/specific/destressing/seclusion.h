...
struct SeclusionLevelInfo : public BuildingLevelInfo
{
    SeclusionLevelInfo()
...
public:
    explicit Seclusion(Base *base, unsigned level, const AnyBuildingLevelsInfo *levelsInfo) noexcept;
...
private:
    SeclusionLevelInfo *currentLevelInfo() const noexcept;
    SeclusionLevelInfo *nextLevelInfo() const noexcept;

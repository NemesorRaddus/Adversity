...
public:
    explicit Shrine(Base *base, unsigned level, const AnyBuildingLevelsInfo *levelsInfo) noexcept;
...
private:
    ShrineLevelInfo *currentLevelInfo() const noexcept;
    ShrineLevelInfo *nextLevelInfo() const noexcept;
